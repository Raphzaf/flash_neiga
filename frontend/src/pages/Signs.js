                ...
                {filteredSigns.map(sign => (
                    ...
                    >
                        <CardContent className="p-4 flex flex-col items-center text-center h-full justify-between">
                            ...
                            <div className="font-medium text-sm leading-tight text-slate-900 dark:text-white">{sign.name}</div>
                        </CardContent>
                    </Card>
                ))}
            </div>
            ...
            <Dialog open={!!selectedSign} onOpenChange={() => setSelectedSign(null)}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-indigo-600 dark:text-indigo-400 font-medium">{selectedSign?.category}</DialogDescription>
                    </DialogHeader>
